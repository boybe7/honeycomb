...
class OtherCostController extends Controller
{
	...
	{
		$model=new OtherCost('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['OtherCost']))
			$model->attributes=$_GET['OtherCost'];
	...
	{
		$model=OtherCost::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='other-cost-form')
		{
